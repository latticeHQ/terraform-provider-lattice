...
locals {
  ...
  output = {
    ...
    "workspace_owner.email" : data.lattice_workspace_owner.me.email,
    "workspace_owner.full_name" : data.lattice_workspace_owner.me.full_name,
    "workspace_owner.groups" : jsonencode(data.lattice_workspace_owner.me.groups),
    "workspace_owner.id" : data.lattice_workspace_owner.me.id,
    "workspace_owner.name" : data.lattice_workspace_owner.me.name,
    "workspace_owner.oidc_access_token" : data.lattice_workspace_owner.me.oidc_access_token,
    "workspace_owner.session_token" : data.lattice_workspace_owner.me.session_token,
    "workspace_owner.ssh_private_key" : data.lattice_workspace_owner.me.ssh_private_key,
    "workspace_owner.ssh_public_key" : data.lattice_workspace_owner.me.ssh_public_key,
  }
}
