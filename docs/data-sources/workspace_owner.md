...
page_title: "lattice_workspace_owner Data Source - terraform-provider-lattice"
subcategory: ""
description: |-
  Use this data source to fetch information about the workspace owner.
---

# lattice_workspace_owner (Data Source)
...
- `session_token` (String) Session token for authenticating with a Lattice deployment. It is regenerated every time a workspace is started.
